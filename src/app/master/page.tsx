            ...
            <table className="w-full table-fixed text-sm">
              <thead className="sticky top-0 bg-slate-50">
                <tr className="text-left text-xs font-semibold text-slate-600">
                  ...
                  <th className="w-[12%] px-4 py-3">Empresa</th>
                  <th className="w-[12%] px-4 py-3">CIF</th>
                  <th className="w-[14%] px-4 py-3">Teléfono</th>
                  <th className="w-[20%] px-4 py-3">Dirección</th>
              ...
              <tbody>
                {(() => {
                  ...
                  <tr key={row.id} className="border-t border-slate-100">
                    ...
                    <td className="w-[12%] px-4 py-3"><TruncateWithTooltip value={row.empresa} /></td>
                    <td className="w-[12%] px-4 py-3"><TruncateWithTooltip value={row.cif ?? ''} /></td>
                    <td className="w-[14%] px-4 py-3"><TruncateWithTooltip value={row.telefono ?? ''} /></td>
                    <td className="w-[20%] px-4 py-3"><TruncateWithTooltip value={row.direccion ?? ''} /></td>
                    <td className="w-[36%] px-4 py-3"><TruncateWithTooltip value={row.email ?? ''} /></td>
                  </tr>
                  ));
                })()}
              </tbody>
        ...
        <Table>
          <div className="max-h-[360px] overflow-y-auto overflow-x-hidden">
            <table className="w-full table-fixed text-sm">
              <thead className="sticky top-0 bg-slate-50">
                <tr className="text-left text-xs font-semibold text-slate-600">
                  <th className="w-[12%] px-4 py-3">Nombre</th>
                  <th className="w-[14%] px-4 py-3">Apellidos</th>
                  <th className="w-[28%] px-4 py-3">Email</th>
                  <th className="w-[20%] px-4 py-3">Empresa</th>
                  <th className="w-[13%] px-4 py-3">CIF</th>
              ...
              <tbody>
                {(() => {
                  ...
                  <tr key={row.user_uid} className="border-t border-slate-100">
                    <td className="w-[12%] px-4 py-3"><TruncateWithTooltip value={row.first_name} /></td>
                    <td className="w-[14%] px-4 py-3"><TruncateWithTooltip value={row.last_name} /></td>
                    <td className="w-[28%] px-4 py-3"><TruncateWithTooltip value={row.user_email} /></td>
                    <td className="w-[20%] px-4 py-3"><TruncateWithTooltip value={row.user_businessname} /></td>
                    <td className="w-[13%] px-4 py-3"><TruncateWithTooltip value={row.user_business_cif ?? ''} /></td>
                    <td className="w-[13%] px-4 py-3"><TruncateWithTooltip value={row.user_role} /></td>
                  </tr>
                  ));
                })()}
              </tbody>
